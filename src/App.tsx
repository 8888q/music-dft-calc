...
type complexNumber = readonly [number, number];
const decimalPrecision: number = 3;
...
function App() {
  ...
  return (
    <Box display="flex" flexDirection="column" gap="32px" alignItems="center" paddingTop="100px" minHeight="100vh" width="100vw" bgcolor="#fce5de" >
      <Typography variant='h3'>Characteristic Function DFT Calculator</Typography>
              ...
              complexNumbers.map( z => {
                ...
                return (
                  <TableRow>
                    ...
                    <TableCell align="right">{theta.toPrecision(decimalPrecision)}</TableCell>
